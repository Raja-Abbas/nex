...
import ChatbotMiniComponent from "../components/ChatbotMiniComponent";
...
export default function BuildPage() {
  ...
  return (
    <div
      className={`grid relative max-lg:px-4 w-full max-lg:h-full lg:h-auto scrollbar overflow-x-hidden gap-[50px] justify-center ${
        showDeploymentDetails
          ? "lg:grid-cols-2 max-lg:grid-cols-1 max-lg:grid-rows-2"
          : "max-lg:grid-cols-1 max-lg:grid-rows-2"
      }`}
    >
      <ChatbotMiniComponent />
      <GithubDeployment
