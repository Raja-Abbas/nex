...
function DashboardPage() {
  return (
    <div className='max-md:w-[300px] max-lg:w-[550px] lg:max-w-[1200px] pt-20 w-full flex flex-col gap-10'>
      ...
      <p className="font-normal max-md:px-1 max-md:text-base md:text-lg rounded-lg py-1 md:px-3 text-dark-blue">Exclusive nexlayer credits <span className="max-md:text-[10px] md:text-xl font-thin mx-5">|</span> $100</p>
      <button
              type="submit"
      ...
      <div className="bg-card-color flex flex-col justify-center items-start gap-3 max-md:text-nowrap max-md:w-[280px] md:w-[380px] border border-[#32474C] relative rounded-lg py-4 max-md:px-2 md:px-6 shadow-xl">
        <p className="text-lg text-white tracking-0 font-[300]">NodeJS Application</p>
        <a href={deploymentData.url} className='flex gap-2 items-center' target="_blank" rel="noreferrer">
            <img src={Globe} alt="Globe" className='w-4 h-5' />
            <p className="text-base text-dark-blue leading-[24px] font-normal">{deploymentData.url}</p>
        </a>
