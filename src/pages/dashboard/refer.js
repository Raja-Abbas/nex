...
const Refer = () => {
  ...
  const handleCopy = (event) => {
    ...
    if (inputRef.current) {
      navigator.clipboard
        .writeText(inputRef.current.placeholder)
        .then(() => {})
        .catch((err) => {
    ...
    <div className="flex w-screen max-lg:flex-col bg-gray-100">
      <aside className="sticky top-0 w-full lg:w-64 px-5 bg-[#202020] bg-gray-800 text-white flex-shrink-0 lg:flex-col lg:justify-between lg:h-auto">
        <div className="flex items-center justify-start h-16 bg-gray-900">
          <h1 className="text-[14px] text-description-color font-medium">
            Menu
          </h1>
        </div>
      ...
      <main className="flex-1 p-6 pt-[8px] overflow-auto lg:ml-[60px]">
            ...
            <form>
              <div className="flex mt-5 gap-10 w-full">
                <div className="w-1/3">
                  <label
                    for="name"
                    className="block text-lg font-normal leading-6 text-gray-900"
                  >
                    Name
                  </label>
                  <div className="mt-2.5">
                    <input
                      ...
                      className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-light-grey-color ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6 bg-[#1b1c1c]"
                    />
                  </div>
                </div>
                <div className="w-1/3">
                  ...
                  <div className="mt-2.5">
                    <input
                      required
                      placeholder="nonosisihoy@gmail.com"
                      type="email"
                      name="email"
                      id="email"
                      autocomplete="email"
                      className="placeholder:text-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-light-grey-color ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6 bg-[#1b1c1c]"
                    />
                  </div>
                </div>
              </div>
              <div className="flex mt-5 gap-10 w-full">
                ...
                <div className="w-1/3">
                  ...
                  <div className="mt-2.5">
                    <input
                      required
                      placeholder="https://avatars.github/noshhoy"
                      type="url"
                      name="avatar-url"
                      id="avatar-url"
              ...
              <ul className="m-6 mb-3 mt-4 flex flex-col gap-3">
                ...
                <li className="flex items-center gap-2">
                  <img
                    ...
                    alt="Tick"
                  />
                  Get $25 in credit for every person you invite.
                </li>
              </ul>
            </div>
            <div
              onClick={() => handleSectionChange("Referrals & Credits")}
              className="cursor-pointer ml-12 underline text-[16px] text-[#28B8CD]"
            >
        ...
        {activeSection === "Referrals & Credits" && (
          <div className="p-6 text-white max-w-[900px]">
            <h2 className="text-[24px] font-normal mb-5">
              Referrals & Credits
            </h2>
            <p className="mb-[10px] text-[20px]">
              Get $25 for every person you refer to Our Platfrom
            </p>
            <p className="text-[#878593] mb-[30px] text-[16px]">
              You’ll receive credit when the person you invite signs up and
              verifies their email. You can rede this credit to upgrade your
              account or access premium features.
            </p>
            <form className="">
              <div>
                <label
                ...
                <div className="mt-2.5 relative">
                  <button
                    className="absolute right-[7px] top-[7px] cursor-pointer"
                    onClick={handleCopy}
                  >
                    <Copy />
                  </button>
                  <input
                    ...
                    id="link"
                    autocomplete="given-name"
                    className="block placeholder:text-white w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-light-grey-color ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6 bg-[#1b1c1c]"
                  />
                </div>
              </div>
              <div className="py-[20px] flex flex-col gap-[5px]">
                ...
                <p className="text-[#878593] text-[16px]">
                  Earned from <span className="text-white">12 referrals</span>
                </p>
              </div>
              <div className="">
                <label
                ...
                <div className="mt-2.5 flex h-fit gap-2">
                  <input
                    ...
                    id="email"
                    autocomplete="email"
                    className="h-fit block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-light-grey-color ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6 bg-[#1b1c1c]"
                  />
                  <button
                    type="submit"
                ...
                <ul className="m-6 mb-3 mt-4 flex flex-col gap-3 text-[16px]">
                  <li className="flex items-center gap-2">
                    <img
                      ...
                      alt="Tick"
                    />
                    $25 Jhon Potter has signed up for Our Platform on 2024-07-15
                  </li>
                  <li className="flex items-center gap-2">
                    <img
                      className="pb-1 w-[16px] h-[16px]"
                      ...
                      alt="Tick"
                    />
                    $25 Sarah Thompson has signed up for Our Platform on
                    2024-07-14
                  </li>
                  <li className="flex items-center gap-2">
                    <img
                      ...
                      alt="Tick"
                    />
                    $25 Michael Chen has signed up for Our Platform on
                    2024-07-13
                  </li>
                </ul>
              </div>
