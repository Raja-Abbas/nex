  ...
  return (
    <div className="max-w-[100%] xl:max-w-[100%] 2xl:max-w-[100%] p-5">
      ...
      <div className="mt-[15px] px-2 py-[8.5px] flex gap-[10px] items-center rounded-[7px] bg-card-color">
        <div className="flex justify-center items-center rounded-[7px] w-[38px] h-[38px] bg-background">
          {selectedCard && (
            <img src={selectedCard.logo} alt="Details Logo" />
          )}
        </div>
        <div>
          <p className="font-normal text-base text-white">
            nexlayer-templates/{selectedCard.title.toLowerCase()}-ssl:latest
          </p>
