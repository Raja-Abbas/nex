    ...
    <div className="bg-background border-b border-line-color">
      <div className="px-2 max-md:px-0 container mx-auto flex justify-between items-center py-[22.5px]">
        ...
        <div className="flex gap-6 items-center">
          <p className="font-normal text-xl text-dark-blue hidden sm:block">Currently in stealth mode 🔒—alpha preview active! Expect wild glitches ⚠️ and surprises ahead 🎢🤪.</p>
