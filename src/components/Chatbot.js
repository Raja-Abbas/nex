...
const ChatBot = ({ onClose }) => {
  return (
    <div className="fixed bottom-[105px] right-10 w-[483px] p-[20px] pt-[50px] bg-background border border-[#333636] p-4 rounded-lg shadow-lg z-[1000]">
      ...
      <div className="p-2">
        ...
        <div className="flex gap-2 text-white">
          ...
          <p className="md:w-[388px] text-base">I'm Liz, your AI assistant. Congratulations on successfully<br/>
             deploying your project and joining our private alpha! <br/>
              You've earned $100 in credits to explore our platform. <br/>
              As we're in the early stages, I'm here to help you make the <br/>
              most of your credits and experience. </p>
        </div>
        <div className="mt-[30px] border border-[#333636] flex justify-between items-center border border-[#2e2e2e] bg-dark-gray rounded-[7px]">
          <input
            type="text"
