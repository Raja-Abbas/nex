  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-gray-900 text-white h-full w-full">
      <div className="text-center mb-[30px]">
        ...
        <h1 className="text-4xl leading-[150%] font-bold">Start your project</h1>
      ...
      <div className="flex max-lg:flex-col max-lg:space-y-4 lg:space-x-4">
        ...
        >
          <div className="flex text-base gap-2 items-center">
            <img src={GithubSvg} alt="GithubSvg" className='w-[24px] h-[24px]' />
            Deploy a public GitHub project
          </div>
          <img src={ArrowRightSvg} alt="ArrowRightSvg" className='w-[24px] h-[24px]' />
        </button>
        <button
