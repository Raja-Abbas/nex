...
const ModalAfterWaitlist: React.FC<ModalAfterWaitlistProps> = ({
  isOpen,
  onClose,
}) => {
      ...
      <div className="bg-background relative text-center bg-opacity-100 z-[1000] p-[26px] pt-[48px] rounded-md shadow-xl my-[45px] mx-[55px] max-md:w-full md:w-auto h-full md:h-auto max-h-[80vh] overflow-y-auto scrollbar">
        ...
        <div className="mt-[45px] text-white">
          <p className="text-[26px] font-medium">
            Welcome to our exclusive private alpha!
          </p>
          <p className="text-lg font-normal mt-[20px] opacity-80">
            Hey there! I'm Liz, your NexLayer guide. You've just unlocked $100
            in credits! As we
            <br className="max-md:hidden" />
            gear up for our beta launch this fall, your early claim powers your
            projects and puts
            <br className="max-md:hidden" />
        ...
        <div className="mt-[45px] text-white">
          ...
          <p className="text-lg font-normal mt-[20px] opacity-80">
            <span className="text-white font-bold">$100 NexLayer Credits:</span>{" "}
            Use 'em to boost your tech game.
            <br className="max-md:hidden" />
            <span className="text-white font-bold">Early Access Pass:</span> Be
            the first to explore our platform.
            <br className="max-md:hidden" />
            <span className="text-white font-bold">
              Game-Changing Opportunity:
            </span>{" "}
            Your ideas will shape NexLayer's features
          </p>
        </div>
        <p className="mt-[45px] opacity-80 text-white text-xl">
          Ready to crush it? Let's build and make waves together! 🚀🖥️
        </p>
        <p className="mt-[45px] text-white text-xl">
          Hurry, Shape NexLayer's Future!
        </p>
        <button
