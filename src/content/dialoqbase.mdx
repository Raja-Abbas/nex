...
\
<strong className="flex">![star](/star-icon.svg)Star on Github: [https://github.com/Mintplex-Labs/dialoqbase](/ "title")</strong>
...
<div className="mt-[0px] px-5 py-4 flex gap-[14px] max-w-[750px] 2xl:max-w-[1014px] items-center rounded-[7px] bg-card-color">
  ...
  <div>
    <p className="font-normal text-base text-white">dialoqbase-docker</p>
    <p className="font-normal text-tiny text-description-color">mintplexlabs/dialoqbase:railway</p>
  </div>
</div>
