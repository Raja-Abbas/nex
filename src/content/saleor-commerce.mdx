...
<strong className="flex">
  ![star](/star-icon.svg)Star on Github: [https://github.com/saleor/saleor](/
  "title")
</strong>
...
- **Dashboard:** User-friendly, fast, and productive. _(Decoupled project repo)_
...
<div className="mt-[0px] px-5 py-4 flex gap-[14px] max-w-[750px] 2xl:max-w-[1014px] items-center rounded-[7px] bg-card-color">
  ...
  <div>
    ...
    <p className="font-normal text-tiny text-description-color">saleor/saleor:latest</p>
  </div>
</div>
